...
@NgModule({
    ...
    imports: [RouterOutlet,CKEditorModule,FormsModule,ReactiveFormsModule,AppRoutingModule,BrowserModule,SimplebarAngularModule,NgxSpinnerModule,BrowserAnimationsModule]
})
